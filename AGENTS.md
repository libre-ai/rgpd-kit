...
GDPR lifecycle brick of the Libre AI constellation (couche 4). Born from the hub dismantling (ADR-0020): history carried by git
filter-repo from packages/rgpd-kit; the hub remains the clonable archive.
